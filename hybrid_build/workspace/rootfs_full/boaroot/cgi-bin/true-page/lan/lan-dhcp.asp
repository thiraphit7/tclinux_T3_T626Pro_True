...
<body onload="init()">
  ...
  <div class="container-full container-resize-height" >
    <FORM name="ConfigForm" action="/cgi-bin/true-page/lan/lan-dhcp.asp" method="post">
      ...
      <div id="dhcpserver" class="element-hide">
        ...
        <div class="row p-1">
          <div class="col-6">
            <div class="title-text-left">DNS Proxy:</div>
          </div>
          <div class="col-6">
  ...
  function CheckForm()
  {
    with(document.forms[0])
    {
      if (dhcpSrvType[2].checked == true) //dhcp enable
      {
		...
		if ( dhcpLeasedTimeFrag.value == 0)
        {
            alert('Max Lease Time can not be 0');
            window.setTimeout( function(){ dhcpLeasedTimeFrag.focus(); }, 0);
            dhcpLeasedTimeFrag.value = "<% tcWebApi_get("Dhcpd_Common","lease","s") %>";
            return false;
        }
