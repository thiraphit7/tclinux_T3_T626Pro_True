...
{	
    ...
    PrintBuf += '<TABLE border=\'1\' class=\'table2_stytle\' cellspacing=\'0\' cellpadding=\'0\' width=' + TabWidth + '>';
	...
	{		
        ...
        strTDStart = '<TD align=\"center\"' + width +'>';
        strTemp = strTDStart + '<INPUT type=\"button\"  class="btns"  value = \"Edit\" id=\"'+ 'editbuttonId' + i + '\" onclick = \"webClickEdit('+'\''+strDomainName+'\''+','+'\''+arrMsgInfo[i][2]+'\''+','+'\''+edit_url+'\''+');\"></TD>';	
		PrintBuf += (strTemp);
		PrintBuf+=("</TR>");
	}
	...
	PrintBuf += ('</TABLE>');
	//PrintBuf+=('</FORM>');
    PrintBuf =  PrintBuf + '<BR><INPUT type=\"button\"  class="btns"  value = \"Add\" onclick = \"webClickAdd('+'\''+strDomainName+'\''+','+'\''+strUrl+'\''+');\" id=\"button\" name=\"button\">';
