...
function levelChange(model)
{
	...
	parent.document.ConfigForm.loglevel_flag.value= \"1\";
...
echo -e "<tr rowspan=\"2\"><td width=\"100\">Display Log Level:&nbsp;</td><td><select name=\"levels\" onChange=\"levelChange(this)\">
<option value=\"0\""
	case "$loglevel" in
	"0" )
	echo -e "selected";;
...
echo -e "<tr rowspan=\"1\"><td colspan=\"2\">&nbsp;</td></tr>"

echo -e "<tr><td colspan=\"2\"><TEXTAREA NAME=\"AlphaLogDisplay\" STYLE=\"WIDTH:453px;HEIGHT:200px;\" WRAP=\"OFF\" EDIT=\"OFF\" READONLY>"
