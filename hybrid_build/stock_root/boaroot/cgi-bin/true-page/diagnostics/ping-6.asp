...
<body>
    ...
    function startPing()
    {
      ...
      if(false == ipv6Check(ip_text)){//需要添加ipv6地址检测
        alert("Host Address\"" + ip_text + "\"is not a valid IPv6 address.");
        setDisplay('PingResult', 0);
        setDisplay('WaitMsgPing', 1);
        return false;
      }else{
...
<!-- content -->
  <form id="PingForm" name="PingForm" method="post" action="/cgi-bin/true-page/diagnostics/ping-6.asp">
  ...
  <input type="hidden" name="AddRoute_Ping" value="">
    <div class="container-full container-resize-height">
      <div class="title-text">Ping6 Diagnostics</div>
      <div class="title-description-text">This page is used to send ICMPv6 ECHO_REQUEST packets to network host. The diagnostic result will then be displayed.</div>
      <br>
      <div class="row p-1">
        <div class="col-6">
      ...
      <div class="mt-2 center">
          <button type="button" id="btnPing" onclick="startPing()" class="btn-dashboard">Go</button>
      </div>
    </div>
  </form>
<!-- content -->
