...
if Request_Form("Save_Flag") = "1" then 
  ...
  tcWebApi_constSet("IpMacFilter_Entry","FilterMode","IPV6")
...
<body>
  ...
  <div class="container-full container-resize-height">
    <form name="ConfigForm" action="/cgi-bin/true-page/advance/advance-ipv6-ipport-filtering.asp" method="post">
      ...
      <div id="FilterOutInfo" class="row" style="display: none;">
        <div class="col-12">
          ...
          <div class="row p-1">
            ...
            <div class="col-6">
              <input class="form-control input-select" name="SourceIPStart" maxLength="39"  size="20"/>
            </div>
          </div>                                          
          <div class="row p-1" style="display:none">
            ...
            <div class="col-6">
              <input class="form-control input-select" name="SourceIpMask" maxLength="39" size="20"/>
            </div>
          </div>
          <% if tcwebApi_get("WebCustom_Entry","isCMCCSupported","h") <> "Yes" then %>
            <div class="row p-1">
              ...
              <div class="col-6">
                <input class="form-control input-select" name="SourceIPEnd" maxLength="39" size="20"/>
              </div>
            </div>
          <% end if %>   
          <div class="row p-1">
            ...
            <% if tcwebApi_get("WebCustom_Entry","isCMCCSupported","h") <> "Yes" then %>
              <span>-</span>
              <div class="col-2">
                <input class="input-textfield" type="text" name="SourcePortEnd" maxLength="39" size="20" />
              </div>
            <% end if %>
          </div>
          <div class="row p-1">
            ...
            <div class="col-6">
              <input class="form-control input-select" name="DestIPStart" maxLength="39"  size="20"/>
            </div>
          </div>
          <div class="row p-1" <% if tcwebApi_get("WebCustom_Entry","isCMCCSupported","h") <> "Yes" then %>style="display:none"<% end if %>>
            ...
            <div class="col-6">
              <input class="form-control input-select" name="DestIpMask" maxLength="39" size="20"/>
            </div>
          </div>
          <% if tcwebApi_get("WebCustom_Entry","isCMCCSupported","h") <> "Yes" then %>
            <div class="row p-1">
              ...
              <div class="col-6">
                <input class="form-control input-select" name="DestIPEnd" maxLength="39" size="20"/>
              </div>
            </div>
          <% end if %>   
          <div class="row p-1">
            ...
            <% if tcwebApi_get("WebCustom_Entry","isCMCCSupported","h") <> "Yes" then %>
              <span>-</span>
              <div class="col-2">
                <input class="input-textfield" type="text" name="DestPortEnd" maxLength="39" size="20" />
              </div>
            <% end if %>
          </div>
  ...
  <script>
    ...
    function checkForm()
    {
        ...
        if (document.ConfigForm.SourceIPStart.value != "" && (isGlobalIpv6Address(document.ConfigForm.SourceIPStart.value) == false))
          {
        ...
        <% if tcwebApi_get("WebCustom_Entry","isCMCCSupported","h") <> "Yes" then %>	
            if (document.ConfigForm.SourceIPEnd.value != ""  && isGlobalIpv6Address(document.ConfigForm.SourceIPEnd.value) == false)
              {
        ...
        */
        ...
        if (document.ConfigForm.DestIPStart.value != ""  && isGlobalIpv6Address(document.ConfigForm.DestIPStart.value) == false && getFullIpv6Address(document.ConfigForm.DestIPStart.value) != "0000:0000:0000:0000:0000:0000:0000:0000")
          {
        ...
        <% if tcwebApi_get("WebCustom_Entry","isCMCCSupported","h") <> "Yes" then %>	
            ...
            if (document.ConfigForm.DestIPEnd.value != "" && isGlobalIpv6Address(document.ConfigForm.DestIPEnd.value) == false && document.ConfigForm.DestIPEnd.value != "ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff")
              {
    ...
    function GetIpUpFilterTable()
    {
      ...
      {
        if(IpUpFilterRule[i]["FilterMode"]=="IPV6"){
    ...
    function RemoveAll()
    {
        ...
        for(i = 0; i < nCount; i++)
        {
            if(IpUpFilterRule[i] != "N/A" && IpUpFilterRule[i]["FilterMode"]=="IPV6")//remove pv6 only
            {
                hasEntry = true;
                tempstr = (IpUpFilterRuleIndex + i) + ",";
                Form.delnum.value = Form.delnum.value + tempstr;
