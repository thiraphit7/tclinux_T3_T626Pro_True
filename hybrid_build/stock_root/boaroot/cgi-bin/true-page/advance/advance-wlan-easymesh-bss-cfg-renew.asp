...
<body>
  ...
  <form method="post" name="cbi" id="add_bss_cfgs_form" action="/cgi-bin/true-page/advance/advance-wlan-easymesh-bss-cfg-renew.asp" autocomplete="off" style="display:none;">
  ...
  <SCRIPT language=JavaScript type=text/javascript>
    ...
    function draw_easymesh_bss_overview_table(alMac, alMacInfo)
    {
        ...
        /*var t = document.createTextNode('AL-MAC: ' + alMac);*/
       	var t = document.createTextNode('Front haul BSS');
        s.appendChild(t);
        b.appendChild(s);
        cell.appendChild(b);
        /* 2G Band */
